...
import weixin.popular.msg.parser.WxMsgKit;
import weixin.popular.msg.recv.WxRecvMsg;
import weixin.popular.msg.send.WxSendMsg;
...
public final class WeiXinTools {
	...
	public static void send(WxSendMsg msg, OutputStream out) throws JDOMException, IOException {
		...
		if (null != doc) {
			...
			Logger.getAnonymousLogger().warning("发送消息时,解析出dom为空 weixin.popular.msg :" + msg);
		}
	}
